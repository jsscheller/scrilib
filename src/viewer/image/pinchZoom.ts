...
export class PinchZoom {
  ...
  constructor() {
    ...
    // Watch for pointers
    const pointerTracker: PointerTracker = new PointerTracker(this.baseEl, {
    ...
    this.baseEl.addEventListener("wheel", (event) => this._onWheel(event));
  }
  ...
  scaleTo(scale: number, opts: ScaleToOpts = {}) {
    ...
    const relativeToEl =
      relativeTo === "content" ? this._positioningEl : this.baseEl;
  ...
  setTransform(opts: SetTransformOpts = {}) {
    ...
    // Get current layout
    const thisBounds = this.baseEl.getBoundingClientRect();
  ...
  private _updateTransform(
    ...
    this.baseEl.style.setProperty("--x", this.x + "px");
    this.baseEl.style.setProperty("--y", this.y + "px");
    this.baseEl.style.setProperty("--scale", this.scale + "");
  }
